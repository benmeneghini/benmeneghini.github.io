...
export const ContactSection = () => {
    ...
    const handleInput = (e: ChangeEvent<HTMLInputElement> | ChangeEvent<HTMLTextAreaElement>, inputType: string) => {
        switch (inputType) {
            case "name":
    ...
    return (
        <div className="flex md:ml-40 justify-center bg-neutral-950">
            <div className="text-center text-amber-50 px-12 py-5 md:grid md:grid-cols-3 place-items-center">
                ...
                <div className="font-bold flex items-center hover:cursor-pointer mt-6" onClick={() => {copyToClipboard(Info.email)}}>
                ...
                <div className="inline-block w-0.5 self-stretch bg-amber-50 opacity-100 dark:opacity-50 mt-6
                    invisible md:visible"></div>

                <div className="font-bold flex items-center hover:cursor-pointer mt-6" onClick={() => {copyToClipboard(Info.number)}}>
                ...
                <div className="md:col-start-2 mt-12 mb-8">
                    <form onSubmit={sendMessage} className="bg-red-50 text-black p-5 rounded grid grid-cols-4 w-72 md:w-96">
                        <label className="text-start mb-1 col-span-2">Name:</label>
                        <label className="text-start ml-2 mb-1 col-span-2">Email:</label>

                        <input className="col-span-2 mr-2 bg-transparent outline outline-1 outline-offset-4 rounded h-8"
                               type="text" id="name" name="name" placeholder="John Doe"
                               onChange={(e) => {handleInput(e, "name")}}
                               value={name}/>
                        <input className="col-span-2 ml-2 bg-transparent outline outline-1 outline-offset-4 rounded h-8"
                        ...
                        <textarea className="bg-transparent col-span-4 outline outline-1 outline-offset-4 rounded h-24"
                               id="message" name="message" placeholder="Hey Ben, I'm John!"
                ...
                <div className="md:col-start-2 mb-2 mt-8">
